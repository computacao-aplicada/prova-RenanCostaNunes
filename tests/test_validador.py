...
class TestValidadorCPF(unittest.TestCase):
    ...
    def test_deve_retornar_true_para_cpf_valido(self):
        cpf_com_mascara = "131.904.919-25" 
        cpf_sem_mascara = "13190491925" 
        cpf_com_espacos = " 131.904.919-25 "
    ...
    def test_deve_rejeitar_entradas_invalidas_nulas_ou_vazias(self):
        ...
        self.assertFalse(validar_cpf("131.904.919-2X"), "Deveria rejeitar caractere inválido 'X'") #
    ...
    def test_deve_rejeitar_cpf_com_dv_incorreto(self):
        self.assertFalse(validar_cpf("131.904.919-24"), "DV incorreto para CPF conhecido") #
